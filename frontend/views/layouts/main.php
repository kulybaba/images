                        ...
                        <div class="col-md-4 col-sm-4 navicons-topbar">
                            <ul>
                                ...
                                <li>
                                    ...
                                    <?= Html::dropDownList('language', Yii::$app->language, ['en-US' => 'English', 'ua-UA' => 'Українська']) ?>
                                    <?= Html::submitButton(Yii::t('menu', 'Change'), [
                        ...
                        <div class="main-nav-wrapper">
                            <nav class="main-menu">
                                ...
                                if (Yii::$app->user->isGuest) {
                                    ...
                                    $menuItems[] = ['label' => Yii::t('menu', 'Newsfeed'), 'url' => ['/site/index']];
